            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <div class="bg-white/10 p-8 rounded-2xl border border-white/10 hover:-translate-y-2 transition transform duration-300">
                    <img src="{{ asset('asssets/img/okoya.jpg') }}" alt="Chad Chris"
                         class="rounded-full mx-auto mb-6 w-40 h-40 object-cover shadow-md">
                    <h4 class="text-xl font-semibold mb-1">Chad Chris</h4>
                ...
                {{-- Team Member 2 --}}
                <div class="bg-white/10 p-8 rounded-2xl border border-white/10 hover:-translate-y-2 transition transform duration-300">
                    <img src="{{ asset('asssets/img/okoya.jpg') }}" alt="Jane Doe"
                         class="rounded-full mx-auto mb-6 w-40 h-40 object-cover shadow-md">
                    <h4 class="text-xl font-semibold mb-1">Jane Doe</h4>
                    <p class="text-primary font-medium mb-3">Chief Financial Officer</p>
                    <p class="text-gray-300 text-sm leading-relaxed">Overseeing financial strategies and operations to ensure growth.</p>
                </div>

                {{-- Team Member 3 --}}
                <div class="bg-white/10 p-8 rounded-2xl border border-white/10 hover:-translate-y-2 transition transform duration-300">
                    <img src="{{ asset('asssets/img/okoya.jpg') }}" alt="John Smith"
                         class="rounded-full mx-auto mb-6 w-40 h-40 object-cover shadow-md">
                    <h4 class="text-xl font-semibold mb-1">John Smith</h4>
                    <p class="text-primary font-medium mb-3">Chief Operating Officer</p>
