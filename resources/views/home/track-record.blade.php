<section class="bg-white">
    <div class="container mx-auto px-6 py-24">
        ...
        <div class="flex flex-wrap justify-between gap-x-6 gap-y-12 pt-12">
            <!-- Card 1 -->
            <div
                class="bg-white shadow-lg rounded-2xl px-8 py-6 border-t-4 border-b-4 border-black space-y-4 w-full sm:w-[48%] lg:w-[23%]">
            ...
            <div
                class="bg-white shadow-lg rounded-2xl px-8 py-6 border-t-4 border-b-4 border-black space-y-4 w-full sm:w-[48%] lg:w-[23%]">
                <p class="text-sm font-semibold text-gray-500 uppercase">2022</p>
                <h3 class="text-lg font-bold text-gray-800">Emerging Market Capt. Ltd</h3>
                <img src="{{ asset('asssets/img/records/russ.png') }}" alt="Russelsmith Logo"
                    class="w-32 h-auto object-contain">
                <div class="text-gray-700 space-y-1">
                    <p class="text-sm">Capital Market</p>
            ...
            <div
                class="bg-white shadow-lg rounded-2xl px-8 py-6 border-t-4 border-b-4 border-black space-y-4 w-full sm:w-[48%] lg:w-[23%]">
                <p class="text-sm font-semibold text-gray-500 uppercase">2022</p>
                <h3 class="text-lg font-bold text-gray-800">Valency Agro Nigeria Limited</h3>
                <img src="{{ asset('asssets/img/records/russ.png') }}" alt="Russelsmith Logo"
                    class="w-32 h-auto object-contain">
                <div class="text-gray-700 space-y-1">
                    <p class="text-sm">Capital Market</p>
