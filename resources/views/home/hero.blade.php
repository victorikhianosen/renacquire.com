<section
    ...
    style="background-image: url('{{ asset('asssets/img/bgg.jpg') }}');">
    ...
    <div class="relative z-10 container mx-auto px-6 py-10 md:py-16">
        <div class="flex justify-center items-center gap-8 flex-wrap lg:flex-nowrap">
            <div class="space-y-5 max-w-2xl">
                <h1 class="font-bold text-[34px] md:text-[70px] leading-none text-white">Innovative Advisory & Investment Solutions</h1>
                <p class="text-white text-sm md:text-[16px] font-normal leading-[26px] text-justify">
